                    ...
                    <h1>Halaman Profil</h1>
                     <form action="">
                       ...
                       <label id="icon" for="email"><i class="icon-envelope "></i></label>
                        <input type="email" name="email" id="email" placeholder="Email" value="yudistira96@gmail.com" style="width:460px;margin-bottom: 20px;" required="required" disabled="disabled"/><br>
                        <label id="icon" for="name"><i class="icon-user"></i></label>
                        <input type="text" name="name" id="name" placeholder="Name" value="Yudistira S" style="width:460px;margin-bottom: 20px" required="required" disabled="disabled"/><br>
                        <label id="icon" for="password"><i class="icon-shield"></i></label>
                        <input type="password" name="password" id="password" placeholder="Password" value="12345" style="width:460px;margin-bottom: 20px" required="required" disabled="disabled"/><br>
                        <label id="icon" for="alamat"><i class="icon-home"></i></label>
                        <input type="text" name="alamat" id="alamat" placeholder="alamat" value="Jalan Gajayana 1 782A, Malang" style="width:460px;margin-bottom: 20px" required="required" disabled="disabled"/><br>
                        <label id="icon" for="notlp"><i class="icon-phone"></i></label>
                        ...
                        <div style="padding-left: 17px;margin-bottom : 15px">
                        ...
                        <a href="#" class="btn btn-warning pull-right" style="margin: 20px 8px 18px 15px;">Edit Profil</a>
