				...
				<div class="container">
					...
					<div class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li><a class="active" href="portfolio-3col.html">Portfolio</a>
								<ul class="drop-down">
			...
			<div class="section-content portfolio-section">
				<div class="container">
					<div class="title-section triggerAnimation animated" data-animate="bounceIn">
						<h1>see our magnificient work</h1>
						<p>Our work speaks for itself, so therefore we mean business and creativity. All of the clients are satisfied with our work. So check some of our creative picks and judge by yourself.</p>
					</div>
				</div>
				<div class="portfolio-container triggerAnimation animated" data-animate="fadeIn">
					...
					<ul class="filter">
						...
						<li><a href="#" data-filter=".branding">Brochures</a></li>
					</ul>

					<div class="portfolio-box full-width four-col">

						<div class="project-post photography branding">
							<img alt="" src="upload/1-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/1-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
						...
						<div class="project-post logo">
							<img alt="" src="upload/2-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/2-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post photography branding">
							<img alt="" src="upload/3-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/3.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post web-development">
							<img alt="" src="upload/4-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/4-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post logo">
							<img alt="" src="upload/5-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/5-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post web-development">
							<img alt="" src="upload/6-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/6-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post photography">
							<img alt="" src="upload/7-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/7-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post web-development">
							<img alt="" src="upload/8-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/8-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post logo branding">
							<img alt="" src="upload/9-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/9-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post photography">
							<img alt="" src="upload/10-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/10-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post web-development">
							<img alt="" src="upload/11-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/11-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
						...
						<div class="project-post logo branding">
							<img alt="" src="upload/12-a.jpg">
							<div class="hover-box">
								<div class="hover-content">
									<div class="inner-hover">
										<a href="single-project.html"><i class="fa fa-link"></i></a>
										<a href="upload/12-a.jpg" class="zoom"><i class="fa fa-search"></i></a>
										<h2>GREAT INTERIOR DESIGN</h2>
										<span>interior / photography</span>
									</div>
								</div>
